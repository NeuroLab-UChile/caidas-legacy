...
class CustomUserAdmin(UserAdmin):
    ...
    list_display = ('get_avatar_display', 'get_full_name_display', 'is_staff_icon', 'get_permissions_display', 'get_last_login_display')
    ...
    def get_readonly_fields(self, request, obj=None):
        ...
        if obj == request.user:
            ...
            return ['is_staff', 'is_superuser', 'groups', 'user_permissions', 'username']
        ...
        for user in queryset:
            try:
                ...
                if hasattr(user, 'profile') and user.profile.profile_image:
                    try:
                        image_path = os.path.join(settings.MEDIA_ROOT, str(user.profile.profile_image))
    ...
    delete_users_safely.short_description = "Eliminar usuarios seleccionados de forma segura"
